...
public class SalaryForMonth {
	...
	public String toString() {
		return "SalaryForMonth [id=" + id + ", month=" + month + ", employee=" + employee.getEmployeeId()
				+ ", baseSalary=" + String.format("%.2f", baseSalary) + ", travel=" + String.format("%.2f", travel)
				+ ", food=" + String.format("%.2f", food) + ", insurance=" + String.format("%.2f", insurance)
				+ ", finalSalary=" + String.format("%.2f", finalSalary) + ", paymentStatus=" + paymentStatus + "]";
	}
